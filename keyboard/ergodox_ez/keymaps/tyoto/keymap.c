...
[BASE] = KEYMAP(  // layer 0 : default
        // left hand
        ALT_T(KC_MUTE), KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_VOLD,
...
[MDIA] = KEYMAP(
    ...
    // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                 KC_TRNS, KC_TRNS, KC_MPLY, KC_MSTP, KC_TRNS, KC_TRNS,
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [2] = ACTION_LAYER_TAP_TOGGLE(MDIA)                 // FN2 - Momentary Layer 1 (Media)
};
